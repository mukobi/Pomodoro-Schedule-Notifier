...
{
    public class StretchPromptRotatorTests
    {
        [Fact]
        public void Next_UsesAllPromptsBeforeRepeating()
        {
            string[] prompts = { "neck", "wrists", "hips", "calves" };
            StretchPromptRotator rotator = new(prompts, new Random(17));
        ...
        {
            string[] prompts = { "neck", "wrists" };
            StretchPromptRotator rotator = new(prompts, new AlwaysZeroRandom());
        ...
        {
            string[] prompts = { "neck", "wrists", "hips" };
            StretchPromptRotator rotator = new(prompts, new Random(23));
